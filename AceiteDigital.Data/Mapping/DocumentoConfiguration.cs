...
namespace AceiteDigital.Data.Mapping
{
    public class DocumentoConfiguration : IEntityTypeConfiguration<Documento>
    {
        public void Configure(EntityTypeBuilder<Documento> builder)
        {
            ...
            builder.Property(p => p.Titulo).IsRequired().HasColumnName("Titulo").HasMaxLength(200);

            builder.Property(p => p.Descricao).IsRequired().HasColumnName("Descricao").HasMaxLength(400);

            builder.Property(p => p.DataCriacao).IsRequired().HasColumnName("DataCriacao").HasColumnType("datetime");
        }
    }
}
